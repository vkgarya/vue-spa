...
var appService = {
  getPosts: function getPosts(categoryId) {
    return new Promise(function (resolve) {
      // `${}` is template string expression
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/wp-json/wp/v2/posts?categories=' + categoryId + '&per+page=6').then(function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vuex_index_js__ = __webpack_require__(21);
...
console.log('Vue Version ' + __WEBPACK_IMPORTED_MODULE_0_vue___default.a.version);
...
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "55b52e2f"
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "8df4a1ce"
var Component = normalizeComponent(
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "d05969b2"
var Component = normalizeComponent(
  __vue_script__,
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('footer', {
    staticClass: "footer"
  }, [_vm._ssrNode("<div class=\"container\"><div class=\"content has-text-centered\">Vijay Krishna</div></div>")])
}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router___default.a({
  ...
  routes: [{ path: '/login', component: Login }, { path: '/category/:id', name: 'category', component: Category }, { path: '/', redirect: 'category/front-end' }, { path: '*', component: NotFound }]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__posts__ = __webpack_require__(23);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  namespaced: true, // Wrap all modules under a namespace
  state: state,
  getters: getters,
  actions: actions,
  mutations: mutations
